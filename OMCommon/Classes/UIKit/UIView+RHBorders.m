...
@implementation UIView (RHBorders)
...
- (void)addAutolayoutTopBorderWithHeight:(CGFloat)height andColor:(UIColor *)color {
    UIView *line = [self createViewBackedTopBorderWithHeight:height andColor:color];
    [self addSubview:line];
}

- (void)addAutolayoutLeftBorderWithWidth:(CGFloat)width andColor:(UIColor *)color {
    UIView *line = [self createViewBackedLeftBorderWithWidth:width andColor:color];
    [self addSubview:line];
}

- (void)addAutolayoutBottomBorderWithHeight:(CGFloat)height andColor:(UIColor *)color {
    UIView *line = [self createViewBackedBottomBorderWithHeight:height andColor:color];
    [self addSubview:line];
}

- (void)addAutolayoutRightBorderWithWidth:(CGFloat)width andColor:(UIColor *)color {
    UIView *line = [self createViewBackedRightBorderWithWidth:width andColor:color];
    [self addSubview:line];
}
